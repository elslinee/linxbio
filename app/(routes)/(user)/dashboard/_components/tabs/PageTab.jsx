...
function PageTab() {
  ...
  return (
    <AnimatedTab className="absolute bottom-24 left-1/2 w-[calc(100vw-2rem)] max-w-[400px] -translate-x-1/2 md:relative md:bottom-auto md:left-auto md:w-[400px] md:translate-x-0">
      <div className="flex h-[calc(100vh-200px)] w-full flex-col rounded-[8px] bg-white md:h-[calc(100vh-100px)]">
        ...
        <div className="custom-scroll flex-1 overflow-y-auto px-4 pb-6">
          ...
          <div className="flex flex-col gap-4 pt-4">
            ...
            {["Blog", "Contact Me", "Subscribe"].map((item, i) => (
