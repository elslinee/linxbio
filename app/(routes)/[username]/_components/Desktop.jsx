...
const Desktop = ({
  ...
  return (
    <div
      ...
      className="sm:flex hidden h-screen max-h-screen items-center justify-center"
    >
      <div
        style={{ backgroundColor: colors.bg }}
        className={`scrollbar-hide relative mx-auto h-fit max-h-[600px] max-w-[600px] overflow-y-auto rounded-xl ${font}`}
      >
        {type == 2 ? (
          <Type_2 />
        ) : type == 3 ? (
